  ...
  return (
    <div className={`gridButtonStyle ${className}`}>
      ...
      <a
        ...
        className={`tron-button ${showButton1 ? "" : "hide"}`}
      >
        <button type="button" className="tron-button-in">
      ...
      <a
        ...
        target={target}
        rel={target === "_blank" ? "noopener noreferrer" : undefined}
        className={`tron-button-light ${!showButton2 ? "hide" : ""}`}
        onClick={onDemoClick}
      >
        <button type="button" className="tron-button-light-in">
